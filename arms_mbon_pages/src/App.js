  ...
  if (page === "") {
    return (
      ...
      <NavBar searchTerm={searchTerm}  setSearchTerm={setSearchTerm}/>
        ...
        <br></br>
        <p>ARMS-MBON is a European Marine Biodiversity Observation Network (MBON) of Autonomous Reef Monitoring Structures (ARMS), with a focus on the identification of hard-bottom species via omics and image techniques. The ARMS units are placed in the vicinity of marine stations, ports, marinas, and long-term ecological research sites (LTER) distributed over Europe and polar regions. The units are emplaced for months at a time and are populated by the surrounding hard-bottom communities. Once the units are retrieved, the organisms that colonised them are sampled and analysed. The aim of ARMS-MBON is to assess the status of, and changes in, the hard-bottom communities of these near-coast environments, using DNA, image, and visual inspection methods. The project started in 2018, and from 2023 it will continue as part of EMBRC&#39;s <a href="https://www.embrc.eu/emo-bon" target="_blank">EMO BON</a> (European Marine Omics Biodiversity Observation Network) project. The webpage for the ARMS-MBON can be found <a href="https://arms-mbon.org/" target="_blank">here</a>, and you can learn more by reading <a href="https://www.frontiersin.org/articles/10.3389/fmars.2020.572680/full" target="_blank">this paper in Frontiers in Marine Research</a>.  </p>
        ...
        <ul>
          <li><strong>Data</strong>: the metadata that are harvested from our various sources, quality controlled (QCd), and then combined.</li>
          <li><strong>Documentation</strong>: the Handbook, Standard Operating Protocols/Procedures, Data Management Plan, and an explanation of working with the ABS (Access and Benefit Sharing) permits. These are used by the ARMS-MBON partners in their field work.</li>
          <li><strong>Templates</strong>: template files for data provision and for sample labels. These are used by the ARMS-MBON partners in their field work.</li>
          </ul>
