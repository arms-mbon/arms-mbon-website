    ...
    return (
      ...
      <NavBar searchTerm={searchTerm}  setSearchTerm={setSearchTerm}/>
        ...
        <ul>
          ...
          <p>The metadata on the ARMS units, the events, the material samples, the images, and the omics are provided here. We use <a href="https://www.ebi.ac.uk/ena/browser/" target="_blank">ENA</a> to store the actual raw sequence files, and <a href="https://plutof.ut.ee/en" target="_blank">PlutoF</a> to store the ARMS images. </p>
          ...
          <li><a href="https://github.com/arms-mbon/Data/tree/main/QualityControlledData" target="_blank"><strong>QualityControlledData</strong></a>
           <ul>  
            <li><a href="https://github.com/arms-mbon/Data/tree/main/QualityControlledData/FromGS" target="_blank"><em>FromGS</em></a>: We use a google sheet to record the metadata for all material samples that have been collected from the ARMS units, and the <a href="https://www.ebi.ac.uk/ena/browser/" target="_blank">ENA</a> accession numbers of the DNA sequences extracted from those samples. The multiple tabs of the google sheet are downloaded to this folder, and subjected to some basic QC (checking the values are formatted correctly and are as expected). </li>
